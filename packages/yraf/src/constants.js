...
export const OWNED_DEPENDENCY_TYPES = [
  "devDependencies",
  "dependencies",
  "optionalDependencies",
];
...
export const RACING_REQUEST_DELAY =
  process.env["YARN_RACING_REQUEST_DELAY"] || 500;

export const PREFERRED_MODULE_CACHE_DIRECTORIES =
