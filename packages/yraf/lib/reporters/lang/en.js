...
const messages = {
  ...
  couldntFindVersionThatMatchesRange:
    "Couldn't find any versions for $0 that matches $1, possible versions: \n$2",
  ...
  frozenLockfile: "Checking frozen lockfile",
  ...
  extraDependenciesNotFoundError: "extraDependencies file $0 not found",
};
